<x-app-layout>
    ...
    <x-slot name="mobileMenu">
        ...
        <a href="{{ route('company-admin.agents.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-uda-green-50 border-l-4 border-uda-green-500">
            <svg class="w-5 h-5 text-uda-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <span class="font-semibold text-uda-green-700">Manage Agents</span>
        </a>
    ...
    <x-slot name="bottomNav">
        ...
        <a href="{{ route('company-admin.agents.index') }}" class="flex flex-col items-center py-2 px-3 text-uda-green-600 font-semibold">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
    ...
    @livewire('company-admin.manage-agents')
