<div class="p-4 max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-gradient-to-r from-uda-yellow-500 to-uda-green-500 dark:from-uda-yellow-600 dark:to-uda-green-600 rounded-xl p-6 text-white shadow-lg dark:shadow-gray-900/50">
        ...
        <p class="text-sm opacity-90">Welcome, {{ Auth::user()->name }}!</p>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-md dark:shadow-gray-900/50 transition-colors duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 dark:text-gray-400 text-sm font-medium mb-1">Companies</p>
                    <p class="text-4xl font-bold text-gray-800 dark:text-gray-100">{{ $totalCompanies }}</p>
                </div>
            ...
            <div class="mt-4">
                <a href="{{ route('super-admin.companies.index') }}" class="text-uda-green-600 dark:text-uda-green-400 font-semibold hover:text-uda-green-700 dark:hover:text-uda-green-500 transition text-sm">
                    Manage Companies →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-md dark:shadow-gray-900/50 transition-colors duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 dark:text-gray-400 text-sm font-medium mb-1">Agents</p>
    ...
    @if($topCompanies->count() > 0)
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 overflow-hidden transition-colors duration-200">
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700/50 px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100">Top Performing Companies</h2>
                    ...
                    <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-800 dark:text-gray-100">{{ $company->name }}</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 overflow-hidden transition-colors duration-200">
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700/50 px-5 py-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">System-wide latest members</p>
        </div>
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-2 mt-2">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ $member->company->name }}</p>
                                </div>
